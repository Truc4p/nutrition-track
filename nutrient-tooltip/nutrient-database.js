...
const NUTRIENT_DATABASE = {
    ...
    "PUFA 18:2": { category: "Polyunsaturated Fatty Acids", explanation: "Basic linoleic acid - the most common omega-6 fat found in vegetable oils and nuts. Essential for healthy skin and cell membranes." },
    "PUFA 18:2 CLAs": { category: "Polyunsaturated Fatty Acids", explanation: "Special modified linoleic acid from dairy and meat that may help with body composition and fat burning." },
    "PUFA 18:2 c": { category: "Polyunsaturated Fatty Acids", explanation: "Natural 'cis' form of linoleic acid - the healthy version found in whole foods like seeds and nuts." },
    "PUFA 18:2 n-6 c,c": { category: "Polyunsaturated Fatty Acids", explanation: "Technical name for natural linoleic acid showing it's an omega-6 fat in its healthy natural shape." },
    "PUFA 18:3": { category: "Polyunsaturated Fatty Acids", explanation: "Basic alpha-linolenic acid (ALA) - the plant-based omega-3 found in flax seeds, walnuts, and chia seeds." },
    "PUFA 18:3 c": { category: "Polyunsaturated Fatty Acids", explanation: "Natural 'cis' form of plant omega-3 (ALA) - the healthy version your body can actually use." },
    "PUFA 18:3 n-3 c,c,c (ALA)": { category: "Polyunsaturated Fatty Acids", explanation: "Full technical name for plant omega-3 (ALA) showing it's in its natural, healthy form from foods like flax and hemp." },
    "PUFA 18:3 n-6 c,c,c": { category: "Polyunsaturated Fatty Acids", explanation: "Gamma-linolenic acid (GLA) - a special omega-6 that's actually anti-inflammatory, found in evening primrose oil." },
    "PUFA 18:3i": { category: "Polyunsaturated Fatty Acids", explanation: "Modified plant omega-3 created during food processing - less common and potentially less beneficial than natural ALA." },
    "PUFA 18:4": { category: "Polyunsaturated Fatty Acids", explanation: "Stearidonic acid - a rare plant omega-3 that's easier for your body to convert to EPA than regular ALA." },
    "PUFA 20:2 c": { category: "Polyunsaturated Fatty Acids", explanation: "Intermediate omega-6 fat your body makes from linoleic acid - involved in inflammation processes." },
    "PUFA 20:2 n-6 c,c": { category: "Polyunsaturated Fatty Acids", explanation: "Technical name for the omega-6 intermediate fat that's part of the inflammation pathway in your body." },
    "PUFA 20:3": { category: "Polyunsaturated Fatty Acids", explanation: "General form of eicosatrienoic acid - a longer omega fat your body makes as it processes essential fatty acids." },
    "PUFA 20:3 c": { category: "Polyunsaturated Fatty Acids", explanation: "Natural form of the omega-6 intermediate fat in the pathway leading to arachidonic acid." },
    "PUFA 20:3 n-3": { category: "Polyunsaturated Fatty Acids", explanation: "Omega-3 intermediate fat your body makes when converting plant ALA into the more powerful EPA found in fish." },
    "PUFA 20:3 n-6": { category: "Polyunsaturated Fatty Acids", explanation: "DGLA - a special omega-6 that can actually reduce inflammation, unlike most other omega-6 fats." },
    "PUFA 20:3 n-9": { category: "Polyunsaturated Fatty Acids", explanation: "Mead acid - an unusual omega-9 fat your body only makes when you're deficient in essential omega-3 and omega-6 fats." },
    "PUFA 20:4": { category: "Polyunsaturated Fatty Acids", explanation: "Basic arachidonic acid - an omega-6 fat important for brain function but can increase inflammation if too high." },
    "PUFA 20:4 n-6": { category: "Polyunsaturated Fatty Acids", explanation: "Technical name for arachidonic acid showing it's an omega-6 fat that can promote inflammation when excessive." },
    "PUFA 20:4c": { category: "Polyunsaturated Fatty Acids", explanation: "Natural form of arachidonic acid found in animal products - important for brain health in moderate amounts." },
    "PUFA 20:5 n-3 (EPA)": { category: "Polyunsaturated Fatty Acids", explanation: "EPA - the powerful anti-inflammatory omega-3 from fish that helps reduce inflammation and supports heart health." },
    "PUFA 20:5c": { category: "Polyunsaturated Fatty Acids", explanation: "Natural form of EPA showing it's the healthy version found in fish and fish oil supplements." },
    "PUFA 21:5": { category: "Polyunsaturated Fatty Acids", explanation: "Rare long-chain omega-3 fat found in small amounts in some marine sources - not well studied." },
    "PUFA 22:2": { category: "Polyunsaturated Fatty Acids", explanation: "Very long omega-6 fat found in small amounts in some foods - not as important as shorter omega-6 fats." },
    "PUFA 22:3": { category: "Polyunsaturated Fatty Acids", explanation: "Long-chain fat found in brain tissue and fish - important for nerve function and brain development." },
    "PUFA 22:4": { category: "Polyunsaturated Fatty Acids", explanation: "Adrenic acid - a very long omega-6 fat found in animal products, related to arachidonic acid." },
    "PUFA 22:5 c": { category: "Polyunsaturated Fatty Acids", explanation: "Natural form of DPA showing it's the healthy version found in fish - works with EPA and DHA for heart health." },
    "PUFA 22:5 n-3 (DPA)": { category: "Polyunsaturated Fatty Acids", explanation: "DPA - the 'middle' omega-3 between EPA and DHA in fish, supports cardiovascular health and healing." },
    "PUFA 22:6 c": { category: "Polyunsaturated Fatty Acids", explanation: "Natural form of DHA showing it's the healthy version found in fish - crucial for brain and eye function." },
    "PUFA 22:6 n-3 (DHA)": { category: "Polyunsaturated Fatty Acids", explanation: "DHA - the most important omega-3 for brain and eye health, especially critical for babies and brain function." },

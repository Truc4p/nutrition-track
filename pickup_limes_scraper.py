...
def get_recipe_details(recipe_url):
    """
    Get detailed information about a specific recipe including name, image, total-time, ingredients
    
    Args:
        recipe_url (str): URL of the recipe
        
    Returns:
        dict: Recipe with all requested details: name, image, total_time, ingredients
    """
    try:
        headers = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36',
...
def main():
    ...
    if get_details:
        print("Fetching detailed recipe information (name, image, total_time, ingredients)...")
        detailed_recipes = []
